...
1. Open a new file in `docs/adr/` with the next number (`0014-...`, etc.).
...
14. Historical operations research is stored in structured JSON libraries under `src/data/history/`.
